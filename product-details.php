    ...
    <div class="row">
        <div class="breadcrumbDiv col-lg-12">
            <ul class="breadcrumb">
                ...
                <li><a href="category.php">MEN COLLECTION</a></li>
                <li><a href="sub-category.php">TSHIRT</a></li>
        ...
        <div id="SimilarProductSlider">
            <div class="item">
                <div class="product">
                	<div class="liked_product">
	                	<a href="#"> 
	                		<img src="images/product/a1.jpg" alt="img" class="liked_product_images"> 
	                	</a>
					</div>
            ...
            <div class="item">
                <div class="product">
                	<div class="liked_product">
		                	<a href="#"> 
		                		<img src="images/product/a2.jpg" alt="img" class="liked_product_images"> 
		                    </a>
	                 </div>
                    <div class="description">
            ...
            <div class="item">
                <div class="product">
                	<div class="liked_product">
                		<a href="#"> 
                			<img src="images/product/a3.jpg" alt="img" class="liked_product_images"> 
                	    </a>
                	</div>
            ...
            <div class="item">
                <div class="product">
                	<div class="liked_product">
                		<a href="#">
                			 <img src="images/product/a4.jpg" alt="img" class="liked_product_images">
                		</a>
                	</div>
            ...
            <div class="item">
                <div class="product">
                	<div class="liked_product">
                		<a href="#">
                			<img src="images/product/30.jpg" alt="img" class="liked_product_images">
                		</a>
                	</div>
                    <div class="description">
            ...
            <div class="item">
                <div class="product">
                   <div class="liked_product">
	                	<a href="#"> 
	                		<img src="images/product/a5.jpg" alt="img" class="liked_product_images"> 
	                	</a>
                	</div>
            ...
            <div class="item">
                <div class="product">
                	<div class="liked_product">
	                	<a href="#"> 
	                		<img src="images/product/36.jpg" alt="img" class="liked_product_images">
	                	</a>
					</div>
                    <div class="description">
            ...
            <div class="item">
                <div class="product">
                	<div class="liked_product">
                		<a href="#"> 
                			<img src="images/product/13.jpg" alt="img" class="liked_product_images"> 
                		</a>
					</div>
                    <div class="description">
