                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix">
                        <ul class="orderStep orderStepLook2">
                            <li class="active"><a href="#"> <i class="fa fa-map-marker "></i> <span> address</span>
                            </a></li>
                            <li class="disabled"><a href="#"> <i class="fa fa-check-square  "></i>
                   ...
                   <div id="checkout_section">
                        ...
                        <div class="box-footer">
                            ...
                            <div class="pull-right"><a class="btn btn-primary btn-small " href="#">
