	...
	{	
		...
		$validation_rules = array(
	       array(
	             'field'   => 'category_name',
	             'label'   => 'Category',
	             'rules'   => 'trim|required|xss_clean|is_unique[shopping_category.category_name]'
	          ),
	       array(
		...
		if(!empty($_POST)){
			...
			$validation_rules = array(
		       array(
		             ...
		             'label'   => 'Category',
		             'rules'   => 'trim|required|xss_clean|callback_edit_unique[shopping_category.category_id.category_name.'.$id.']'
		          ),
		       array(
	...
	{	
		...
		$validation_rules = array(
	       array(
	             ...
	             'rules'   => 'trim|required|xss_clean|is_unique[shopping_recipient.recipient_type]'
	          ),
	       array(
	             'field'   => 'select_category[]',
	             'label'   => 'Select Category',
		...
		if(!empty($_POST)){
			...
			$validation_rules = array(
		       array(
		             ...
		             'label'   => 'Recipient name',
		             'rules'   => 'trim|required|xss_clean|callback_edit_unique[shopping_recipient.recipient_id.recipient_type.'.$id.']'
		       ),
		       array(
	             'field'   => 'select_category[]',
	             'label'   => 'Select Category',
		...
		if(!empty($_POST)){
			...
			$validation_rules = array(
		       array(
		             ...
		             'label'   => 'Customer Name',
		             'rules'   => 'trim|required|xss_clean|min_length[5]|max_length[12]|callback_edit_unique[shopping_users.user_id.user_name.'.$id.']'
		          ),
		       array(
		       ...
		       array(
		             ...
		             'label'   => 'Email',
		             'rules'   => 'trim|required|xss_clean|valid_email|callback_edit_unique[shopping_users.user_id.user_email.'.$id.']'
		          ),
	          array(
		...
		if(!empty($_POST)){
			...
			$validation_rules = array(
		       array(
		             ...
		             'label'   => 'Order',
		             'rules'   => 'trim|required|xss_clean|max_length[12]|callback_edit_unique[shopping_users.user_id.user_name.'.$id.']'
		          ),
		       array(
