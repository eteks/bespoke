                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix">
                        <ul class="orderStep orderStepLook2">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>checkout_3"><i
                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <div class="cartFooter w100">
                                    <div class="box-footer">
                                        <div class="pull-left"><a class="btn btn-default" href="<?php echo base_url(); ?>checkout_2"> <i
                                                class="fa fa-arrow-left"></i> &nbsp; Shipping address </a></div>
                                        <div class="pull-right"><a href="<?php echo base_url(); ?>checkout_4"
