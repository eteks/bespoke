            ...
            <div class="row userInfo">
                ...
                <div class="col-xs-12 col-sm-4">
                    ...
                    <form role="form">
                        ...
                        <div class="form-group">
                            <p><a title="Recover your forgotten password" href="<?php echo base_url(); ?>forgot_password">Forgot your
                                password? </a></p>
                        </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    ...
                    <a href="<?php echo base_url(); ?>checkout_1" class="btn btn-primary"><i class="fa fa-sign-in"></i> Checkout as
                        Guest</a></div>
            </div>
            <!--/row end-->
