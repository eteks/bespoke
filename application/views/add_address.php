            ...
            <div class="row userInfo">
                ...
                <form>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group required">
                            ...
                            <select required name="InputCountry" class="form-control" id="InputCountry">
                ...
                <div class="col-lg-12 col-xs-12  clearfix ">
                    ...
                    <ul class="pager">
                        ...
                        <li class="next pull-left"><a href="<?php echo base_url(); ?>my_address">&larr; Back to My Address</a></li>
                    </ul>
                </div>
