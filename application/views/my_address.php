        ...
        <div class="col-lg-9 col-md-9 col-sm-7">
            ...
            <div class="row userInfo">
                ...
                <div class="w100 clearfix">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer panel-footer-address"><a href="<?php echo base_url(); ?>add_address"
                ...
                <div class="col-lg-12 clearfix">
                    <a class="btn   btn-primary" href="<?php echo base_url(); ?>add_address"><i class="fa fa-plus-circle"></i> Add New
                        Address </a>
                </div>
