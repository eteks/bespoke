                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix">
                        <ul class="orderStep orderStepLook2">
                            <li><a href="<?php echo base_url(); ?>checkout_1"> <i class="fa fa-map-marker "></i> <span> address</span> </a>
                            </li>
                            <li class="active"><a href="<?php echo base_url(); ?>checkout_2"> <i class="fa fa fa-envelope  "></i> <span> Billing </span></a>
                            </li>
                            ...
                            <li><a href="<?php echo base_url(); ?>checkout_5"><i class="fa fa-check-square "> </i><span>Order</span></a>
                            </li>
                        </ul>
                        <!--/.orderStep end-->
                    </div>
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            ...
                            <div class="pull-left">
                                <a class="btn btn-default" href="<?php echo base_url(); ?>checkout_1"> <i class="fa fa-arrow-left"></i>
                                    &nbsp; Shipping address </a></div>
                            <div class="pull-right">
                                <a href="<?php echo base_url(); ?>checkout_3" class="btn btn-primary btn-small "> Shipping method &nbsp; <i
