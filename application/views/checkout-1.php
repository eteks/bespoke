                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix">
                        <ul class="orderStep orderStepLook2">
                            <li class="active"><a href="checkout-1.php"> <i class="fa fa-map-marker "></i> <span> address</span>
                            </a></li>
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            ...
                            <div class="pull-right"><a class="btn btn-primary btn-small " href="checkout-2.php">
