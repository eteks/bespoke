    ...
    <div class="row">
        <div class="breadcrumbDiv col-lg-12">
            <ul class="breadcrumb">
                ...
                <li><a href="<?php echo base_url(); ?>category">MEN COLLECTION</a></li>
                <li><a href="sub-<?php echo base_url(); ?>category">TSHIRT</a></li>
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="main-image sp-wrap col-lg-12 no-padding">
                ...
                <a href="<?php echo base_url(); ?>assets/img/product_details/hi-res-croped/1.jpg"><img
                        src="<?php echo base_url(); ?>assets/img/product_details/low-res-white/1.jpg" class="img-responsive" alt="img"></a>
                <a href="<?php echo base_url(); ?>assets/img/product_details/hi-res-croped/2.jpg"><img
                        src="<?php echo base_url(); ?>assets/img/product_details/low-res-white/2.jpg" class="img-responsive" alt="img"></a>
                <a href="<?php echo base_url(); ?>assets/img/product_details/hi-res-croped/3.jpg"><img
                        src="<?php echo base_url(); ?>assets/img/product_details/low-res-white/3.jpg" class="img-responsive" alt="img"></a></div>
        </div>
        <!--/ left column end -->
