    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-cart">    <i class="fa fa-shopping-cart colorWhite"> </i> 
                <span class="cartRespons colorWhite"> Cart ($210.00) </span>
            </button>
        ...
        <div class="navbar-cart  collapse">
            <div class="cartMenu  col-lg-4 col-xs-12 col-md-4 ">
                ...
                <div class="miniCartFooter  miniCartFooterInMobile text-right">
                    ...
                    <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>cart"> 
                ...
                <div class="dropdown  cartMenu ">
                    ...
                    <div class="dropdown-menu col-lg-4 col-xs-12 col-md-4 ">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr class="miniCartProduct">
                                        <td style="width:20%" class="miniCartProductThumb">
                                            <div>
                                                <a href="<?php echo base_url(); ?>product_details/<?php echo $cart_list['product_id']; ?>"> 
                                                    <img src="<?php echo base_url().$cart_list['product_upload_image']; ?>" alt="img">
                                                </a>
                                            </div>
                                        </td>
                                        <td style="width:40%">
                                            <div class="miniCartDescription">
                                                <h4>
                                                    <a href="<?php echo base_url(); ?>product_details/<?php echo $cart_list['product_id']; ?>">     <?php echo $cart_list['product_title']; ?>
                                                    </a>
                                                </h4>
                                                <div class="price"><span> &#8377; <?php echo $cart_list['orderitem_price']; ?> </span></div>
                                            </div>
                                        </td>
                                        <td style="width:10%" class="miniCartQuantity"><a> X <?php echo $cart_list['orderitem_quantity']; ?> </a></td>
                                        <?php
                                        $product_total = number_format($cart_list['orderitem_quantity']*$cart_list['orderitem_price'],2); 
                                        ?>
                                        <td style="width:15%" class="miniCartSubtotal">
                                            <span> &#8377;  <?php echo $product_total; ?> </span>
                                        </td>
                                        <td class="delete" style="width:5%">
                                            <a class="delete_item_cart_list" data-pro_id="<?php echo $cart_list['product_id']; ?>" data-grp_id="<?php echo $cart_list['orderitem_product_attribute_group_id']; ?>"> 
                                                <i class="glyphicon glyphicon-trash fa-2x"></i>
                                            </a>
                                        </td>
                                    </tr>
                                    <?php 
                                    $total +=  $cart_list['orderitem_quantity']*$cart_list['orderitem_price']; 
                                    ?> 
                                    <?php
                                    endforeach;
                                    ?>
                        ...
                        <div class="miniCartFooter text-right">
                            <h3 class="text-right subtotal"> Subtotal: &#8377; <?php echo number_format(ceil($total),2); ?> </h3>
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>cart"> 
