            ...
            <div class="row userInfo">
                ...
                <div class="col-xs-12 col-sm-4">
                    ...
                    <form role="form">
                        ...
                        <div class="form-group">
                            <p><a title="Recover your forgotten password" href="forgot-password.php">Forgot your
                                password? </a></p>
                        </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    ...
                    <a href="checkout-1.php" class="btn btn-primary"><i class="fa fa-sign-in"></i> Checkout as
                        Guest</a></div>
            </div>
            <!--/row end-->
