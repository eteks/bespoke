        ...
        <div class="col-lg-12 ">
            <div class="row userInfo">
                ...
                <div class="thanxContent text-center">
                    ...
                    <h1> Thank you for your order <a href="order-status.php">#6469</a></h1>
                        ...
                        <table style="width:100%" class="cartTable cartTableBorder">
                            ...
                            <tr class="CartProduct">
                                <td class="CartProductThumb">
                                    <div><a href="product-details.php"><img alt="img" src="images/product/a1.jpg"></a>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="CartProduct">
                                <td class="CartProductThumb">
                                    <div><a href="product-details.php"><img alt="img" src="images/product/a2.jpg"></a>
                                    </div>
                                </td>
                                <td>
                                    <div class="CartDescription">
                            ...
                            <tr class="CartProduct">
                                <td class="CartProductThumb">
                                    <div>
                                        <a href="product-details.php"><img alt="img" src="images/product/a5.jpg"></a>
                                    </div>
                                </td>
