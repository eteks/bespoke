                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <div class="product_name">
                                <a href="<?php echo base_url(); ?>products_view">
                        ...
                        <div class="description">
                            <h4>
                                <a href="<?php echo base_url(); ?>products_view"><?php echo $new_arr['product_title']; ?> </a>
                            </h4>
...
<div class="col-lg-5 col-md-5 col-sm-5  col-xs-12">
    ...
    <div class="main-image  col-lg-12 no-padding style3">
        <a class="product-largeimg-link" href="product-details.php"><img
