        ...
        <div id="productslider" class="owl-carousel owl-theme">
            <div class="item">
                <div class="product">
                    ...
                    <div class="description">
                        <h4><a href="<?php echo base_url(); ?>product_details">consectetuer adipiscing </a></h4>
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="description">
                        <h4><a href="<?php echo base_url(); ?>product_details">luptatum zzril delenit</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                        <span class="size">XL / XXL / S </span></div>
                    <div class="price"><span>$25</span></div>
                    <div class="action-control"><a data-toggle="modal" class="btn btn-primary" data-target="#productSetailsModalAjax"> <span class="add2cart"><i class="glyphicon glyphicon-shopping-cart"> </i> Add to cart </span> </a></div>
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="description">
                        <h4><a href="<?php echo base_url(); ?>product_details">eleifend option </a></h4>
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="description">
                        <h4><a href="<?php echo base_url(); ?>product_details">mutationem consuetudium </a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                        <span class="size">XL / XXL / S </span></div>
                    <div class="price"><span>$25</span></div>
                    <div class="action-control"><a data-toggle="modal" class="btn btn-primary" data-target="#productSetailsModalAjax"> <span class="add2cart"><i class="glyphicon glyphicon-shopping-cart"> </i> Add to cart </span> </a></div>
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="description">
                        <h4><a href="<?php echo base_url(); ?>product_details">feugait nulla facilisi</a></h4>
            ...
            <div class="row xsResponse categoryProduct">
                ...
                <div class="item itemauto col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details"> Product Slider </a></h4>
                ...
                <div class="item itemauto col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details"> Slider FadeIn </a></h4>
                ...
                <div class="item itemauto  col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details"> Hover FadeIn </a></h4>
                ...
                <div class="item itemauto  col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="product">
                        ...
                        <div class="imageHover imageHoverFlip">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/7.jpg" alt="img"
                        ...
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details"> Hover Flip </a></h4>
            ...
            <div class="row xsResponse">
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/31.jpg" alt="img" class="img-responsive"></a>
							<div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/34.jpg" alt="img" class="img-responsive"></a>
                            <div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/12.jpg" alt="img" class="img-responsive"></a>
                            <div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/33.jpg" alt="img" class="img-responsive"></a>
                        	<div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/10.jpg" alt="img" class="img-responsive"></a>
                            <div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details">sequitur mutationem </a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/37.jpg" alt="img" class="img-responsive"></a>
                            <div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details">consuetudium lectorum.</a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/35.jpg" alt="img" class="img-responsive"></a>
                            <div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details">parum claram</a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/13.jpg" alt="img" class="img-responsive"></a>
                            <div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details">duis dolore </a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/21.jpg" alt="img" class="img-responsive"></a>
                            <div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details">aliquam erat volutpat</a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/14.jpg" alt="img" class="img-responsive"></a>
							<div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details">ullamcorper suscipit lobortis </a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            <a href="<?php echo base_url(); ?>product_details"><img src="<?php echo base_url(); ?>assets/img/product/17.jpg" alt="img" class="img-responsive"></a>
                            <div class="product_name"><a><span>Product Name</span></a></div>
                        </div>
                        <div class="description">
                            <h4><a href="<?php echo base_url(); ?>product_details">demonstraverunt lectores </a></h4>
