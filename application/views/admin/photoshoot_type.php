...
<div class="ch-container">
    ...
    <div class="box-header well" data-original-title="">
        <h2><!-- <i class="glyphicon glyphicon-user"></i>  -->Photoshoot Type</h2>
   ...
   <div class="box-content">
        ...
        <a class="btn btn-success" id="add" href="<?php echo base_url(); ?>admin/photography/add_photoshoot_type">
        ...
        <?php foreach ($photoshoot_type_list as $ptype): ?>
            <tr>
                <td><?php echo $ptype["display_title"] ?></td>
                <td class="center description" style="width:100% !important"><?php echo $ptype['display_description'] ?></td>
                ...
                <td class="center">
                    <a class="btn btn-info" href="<?php echo base_url(); ?>admin/photography/edit_photoshoot_type/<?php echo $ptype["display_id"] ?>">
                     ...
                     <a class="btn btn-danger delete" href="#myModal1" data-toggle="modal" data-id="<?php echo $ptype["display_id"] ?>" title="Delete">
