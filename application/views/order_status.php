            ...
            <div class="row userInfo">
                ...
                <div class="statusContent">
                    ...
                    <div class="col-sm-6">
                        <div class="order-box">
                            ...
                            <div class="order-box-content">
                                <div class="address">
                                    <p>Payment via Master Card <span style="color: green"
                                                                     class="green"> <strong>(Paid)</strong> </span></p>
                                    ...
                                    <table class="order-details-cart">
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="<?php echo base_url(); ?>product_details"> <img alt="img" src="<?php echo base_url(); ?>assets/img/product/3.jpg">
                                                </a></div>
                                            </td>
                                            <td style="width:40%">
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="<?php echo base_url(); ?>product_details"> <img alt="img"
                                                                                          src="<?php echo base_url(); ?>assets/img/product/2.jpg">
                                                </a></div>
                                            </td>
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="<?php echo base_url(); ?>product_details"> <img alt="img"
                                                                                          src="<?php echo base_url(); ?>assets/img/product/5.jpg">
                                                </a></div>
                                            </td>
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="<?php echo base_url(); ?>product_details"> <img alt="img"
                                                                                          src="<?php echo base_url(); ?>assets/img/product/3.jpg">
                                                </a></div>
                                            </td>
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="<?php echo base_url(); ?>product_details"> <img alt="img"
                                                                                          src="<?php echo base_url(); ?>assets/img/product/4.jpg">
                                                </a></div>
                                            </td>
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="<?php echo base_url(); ?>product_details"> <img alt="img"
                                                                                          src="<?php echo base_url(); ?>assets/img/site/winter.jpg">
                                                </a></div>
                                            </td>
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                ...
                <div class="col-lg-12 clearfix">
                    <ul class="pager">
                        ...
                        <li class="next pull-left"><a href="<?php echo base_url(); ?>account"> ← Back to My Account</a></li>
                    </ul>
                </div>
            </div>
            <!--/row end-->
