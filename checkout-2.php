                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix">
                        <ul class="orderStep orderStepLook2">
                            <li><a href="checkout-1.php"> <i class="fa fa-map-marker "></i> <span> address</span> </a>
                            </li>
                            <li class="active"><a href="checkout-2.php"> <i class="fa fa fa-envelope  "></i> <span> Billing </span></a>
                            </li>
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            ...
                            <div class="pull-left">
                                <a class="btn btn-default" href="checkout-1.php"> <i class="fa fa-arrow-left"></i>
                                    &nbsp; Shipping address </a></div>
                            <div class="pull-right">
                                <a href="checkout-3.php" class="btn btn-primary btn-small "> Shipping method &nbsp; <i
