    ...
    <div class="row">
        <div class="breadcrumbDiv col-lg-12">
            <ul class="breadcrumb">
                ...
                <li><a href="category.php">WOMEN COLLECTION</a></li>
                                ...
                                <li class="active dropdown-tree open-tree"><a class="dropdown-tree-a"> <span
                                    ...
                                    <ul class="category-level-2 dropdown-menu-tree">
                                        <li class="dropdown-tree open-tree"><a class="dropdown-tree-a" href="#">
                                            Tshirt</a>
                                            <ul class="category-level-2 dropdown-menu-tree">
                                                <li><a href="sub-category.php">New</a></li>
                                                <li><a href="sub-category.php">Denim</a></li>
                                                <li><a href="sub-category.php">Fragrances</a></li>
                                                <li><a href="sub-category.php">Scarf</a></li>
                                                <li><a href="sub-category.php">Sandal</a></li>
                                                <li><a href="sub-category.php">Winter Collection</a></li>
                                                <li><a href="sub-category.php"> Accessories</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="sub-category.php"> Shirt</a></li>
                                        <li><a href="sub-category.php"> Fragrances</a></li>
                                        <li><a href="sub-category.php">Scarf</a></li>
                                        <li><a href="sub-category.php">Sandal</a></li>
                                        <li><a href="sub-category.php">Winter Collection</a></li>
                                        <li><a href="sub-category.php">Men Accessories</a></li>
                                    </ul>
                                </li>
